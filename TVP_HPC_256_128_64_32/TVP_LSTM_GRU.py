...
plt.savefig(path+"images/training_loss.png", dpi=1200)
#plt.show()
...
fig.tight_layout()
plt.savefig(path+"images/mean_absolute_error_loss.png", dpi=1200)
#plt.show()
...
fig.tight_layout()
plt.savefig(path+"images/prediction_1.png", dpi=1200)
...
fig.tight_layout()
plt.savefig(path+"images/prediction_2.png", dpi=1200)
