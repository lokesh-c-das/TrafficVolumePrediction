...
path = ""
fileName = path+"LSTM_GRU_REDUCE_STATE_6.txt"
...
LSTM_CheckPoint = ModelCheckpoint(path+'reduced_feature_model/model_lstm_'+str(past_observation)+'/', save_best_only=True)
GRU_CheckPoint = ModelCheckpoint(path+'reduced_feature_model/model_gru_'+str(past_observation)+'/', save_best_only=True)
...
plt.savefig(path+"reduced_feature_images/training_loss_"+str(past_observation)+".png", dpi=1200)
#plt.show()
...
fig.tight_layout()
plt.savefig(path+"reduced_feature_images/mean_absolute_error_loss_"+str(past_observation)+".png", dpi=1200)
#plt.show()
...
lstm_model = load_model(path+'reduced_feature_model/model_lstm_'+str(past_observation)+'/')
gru_model = load_model(path+'reduced_feature_model/model_gru_'+str(past_observation)+'/')
...
fig.tight_layout()
plt.savefig(path+"reduced_feature_images/prediction_0_"+str(past_observation)+".png", dpi=1200)
...
fig.tight_layout()
plt.savefig(path+"reduced_feature_images/prediction_1_"+str(past_observation)+".png", dpi=1200)
...
fig.tight_layout()
plt.savefig(path+"reduced_feature_images/prediction_2_"+str(past_observation)+".png", dpi=1200)
...
fig.tight_layout()
plt.savefig(path+"reduced_feature_images/prediction_3_"+str(past_observation)+".png", dpi=1200)
file.close()
